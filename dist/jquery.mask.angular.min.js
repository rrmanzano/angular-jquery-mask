 ...
 **/
var AngularMaskPluginUtils;!function(n){var a=function(){function n(n){var a=this;this.foo=function(n){},this.action=function(){for(var n=[],t=0;t<arguments.length;t++)n[t]=arguments[t];var r=a.$scope.$parent.$eval(a.propertyName);r&&(a.$scope.$root.$$phase?r.apply(a.$scope.$parent,n):a.$scope.$parent.$apply(function(){r.apply(a.$scope.$parent,n)}))},this.$scope=n}return n}();n.EventHandler=a}(AngularMaskPluginUtils||(AngularMaskPluginUtils={}));var AngularMaskPlugin;!function(n){var a=function(){function n(){this.restrict="A",this.require="ngModel",this.scope={options:"=?maskOptions"},this.link=function(n,a,t,r){var i={};n.options&&angular.copy(n.options,i),r.$parsers.push(function(n){return t.maskModelClean?a.cleanVal():n}),r.$formatters.push(function(n){return n?a.masked(n):(a.unmask().mask(t.maskInput,i),n)});!function(){if(t.maskEvents){var a=n.$eval(t.maskEvents);for(var r in a)if(a[r]){var s=new AngularMaskPluginUtils.EventHandler(n);s.propertyName=a[r],i[r]=s.action}}}(),a.mask(t.maskInput,i)}}return n.factory=function(){return function(a){return new n}},n}();n.MaskDirective=a}(AngularMaskPlugin||(AngularMaskPlugin={})),angular.module("angular-mask-plugin",[]).directive("maskInput",AngularMaskPlugin.MaskDirective.factory());